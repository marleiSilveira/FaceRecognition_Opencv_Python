...
for caminhoImagem in caminhos:
    ...
    facesDetectadas = detectorFace.detectMultiScale(imagemFaceNP)# se não detectar uma face, mexa no detectmultiscale
    for (x, y, l, a) in facesDetectadas:
        ...
        # cv2.waitKey(1000)
percentualAcerto = (totalAcertos / 30) * 100 # 30 é a base teste yale
